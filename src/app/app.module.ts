...
const routes: Routes = [
  ...
  {path: 'entrenador/ejercicio/detalle/:id', component: EEjercicioDetalleComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/ejercicio/editar/:id', component: EEjercicioEditarComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/ejercicio/crear', component: EEjercicioCrearComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametro/buscar', component: EpParametroBuscarComponent},
  {path: 'entrenador/parametro/parametro/crear', component: EpParametroCrearComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametro/detalle/:id', component: EpParametroDetalleComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametro/editar/:id', component: EpParametroEditarComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametrogrupo/buscar', component: EpParametrogrupoBuscarComponent},
  {path: 'entrenador/parametro/parametrogrupo/crear', component: EpParametrogrupoCrearComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametrogrupo/detalle/:id', component: EpParametrogrupoDetalleComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametrogrupo/editar/:id', component: EpParametrogrupoEditarComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametrovalor/buscar', component: EpParametrovalorBuscarComponent},
  {path: 'entrenador/parametro/parametrovalor/crear', component: EpParametrovalorCrearComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametrovalor/detalle/:id', component: EpParametrovalorDetalleComponent, canActivate: [OktaAuthGuard]},
  {path: 'entrenador/parametro/parametrovalor/editar/:id', component: EpParametrovalorEditarComponent, canActivate: [OktaAuthGuard]},
